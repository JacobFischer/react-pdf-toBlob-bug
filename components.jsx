...
import { pdf, BlobProvider, PDFDownloadLink, Document, Page, Text } from '@react-pdf/renderer'

const BlobLink = ({ blob, ...props }) => (blob
...
export const DownloadFromPDFtoString = () => {
    ...
    if (!blob && !error) {
        pdf(PdfDoc).toString()
            .then((str) => setBlob(new Blob([str], { type: 'application/pdf' })))
            .catch(setError);
    }
